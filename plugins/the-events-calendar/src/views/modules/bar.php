		...
		<?php if ( count( $views ) > 1 ) { ?>
			<div id="tribe-bar-views">
				<div class="tribe-bar-views-inner tribe-clearfix">
					...
					<label><?php esc_html_e( 'Visualizar Como', 'the-events-calendar' ); ?></label>
			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<input class="tribe-events-button tribe-no-param" type="submit" name="submit-bar" value="<?php echo esc_attr( sprintf( __( 'Procurar %s', 'the-events-calendar' ), tribe_get_event_label_plural() ) ); ?>" />
					</div>
					<!-- .tribe-bar-submit -->
				</div>
