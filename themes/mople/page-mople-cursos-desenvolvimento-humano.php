<?php
/*
Template Name: Mople Cursos Desenvolvimento Humano
*/
?>
...
<?php get_header(); ?>
    ...
    <div class="container">
		<div id="content" class="clearfix">
					...
					<div class="box">
						...
						<div class="col-md-8">
							<select id="course_list" >
								...
								<?php $my_query = new WP_Query('tribe_events_cat=desenvolvimento-humano-lista-de-cursos'); ?>
								<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
			...
			<?php 
				# Event Type
				$my_query = new WP_Query('tribe_events_cat=desenvolvimento-humano-lista-de-cursos');
			?>  
			<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
			<?php
...
-->
<!-- 			<?php echo do_shortcode('[mople-list-cursos cat="desenvolvimento-humano&showposts="100"" ]'); ?> -->
